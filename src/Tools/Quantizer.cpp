...
int __cdecl PeRedCompare(const void *c1, const void *c2){
	return ((PE*)c1)->peRed - ((PE*)c2)->peRed; }
int __cdecl PeGreenCompare(const void *c1, const void *c2){
	return ((PE*)c1)->peGreen - ((PE*)c2)->peGreen; }
int __cdecl PeBlueCompare(const void *c1, const void *c2){
	return ((PE*)c1)->peBlue - ((PE*)c2)->peBlue; }
int __cdecl PeRedOverBlueCompare(const void *c1, const void *c2){
	return (((PE*)c1)->peRed - ((PE*)c1)->peBlue) - (((PE*)c2)->peRed - ((PE*)c2)->peBlue); }
int __cdecl PeGreenOverBlueCompare(const void *c1, const void *c2){
	return (((PE*)c1)->peGreen - ((PE*)c1)->peBlue) - (((PE*)c2)->peGreen - ((PE*)c2)->peBlue); }
int __cdecl PeBrightnessCompare(const void *c1, const void *c2){
...
inline UCHAR MixTable::BestColor(PALETTEENTRY *pe, UCHAR r, UCHAR g, UCHAR b){
...
int __cdecl PeCompare(const void *c1, const void *c2){
	return
		(
